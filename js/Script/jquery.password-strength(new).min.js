							...
							{ return "No spaces!"; 
								...
								if (inValidChars !== "") 
									{ return "Invalid character: " + inValidChars; 
										...
										var password_settings = { minLength: 8, maxLength: 25, specialLength: 1, upperLength: 1, numberLength: 1, barWidth: 200, barColor: "green", specialChars: "!@#$%*()_+^&;:?", metRequirement: false, useMultipleColors: 1 }; 
										...
										password_settings.minLength = parseInt(password.minLength);
										  ...
										  password_settings.numberLength = parseInt(password.numberLength);
											...
											return this.each(function()
												...
												var container = $("<span></span>").css({ position: "absolute", top: barTopPos - 6, left: barLeftPos + 15, "font-size": "75%", display: "inline-block", width: password_settings.barWidth + 40 }); $(this).after(container); var passIndi = $('<div id="PasswordStrengthBorder"></div><div id="PasswordStrengthBar" class="BarIndicator"></div>').css({ position: "absolute", display: "none" }).eq(0).css({ height: 3, top: barTopPos - 16, left: barLeftPos + 15, "border-style": "solid", "border-width": 1, padding: 2 }).end().eq(1).css({ height: 5, top: barTopPos - 14, left: barLeftPos + 17 }).end(); 
